...
*  **Basic architecture**: We decided to build a plan, which services would be used and the effect. we had create DFD first to develop AWS architecture to visualize not only backend but also frontend.<img src="./DataFlowLv1.png"><img src="./CheckIn.png"><img src="./CheckOut.png">![](https://i.imgur.com/BNDGoKg.png)![](https://i.imgur.com/MoUUQZK.png)
...
*  **Frontend**: We had build the app which can read NFC signal.<img src="./Transaction.png">![](https://i.imgur.com/xPVfW4G.jpg)
